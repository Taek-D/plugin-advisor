...
export const REASONS: Record<string, string> = {
  ...
  "agency-agents":
    "프론트엔드, 백엔드, 마케팅, PM처럼 역할을 분리해 협업하고 싶은 흐름이 보여요. The Agency는 전문가 페르소나를 팀처럼 활용하는 데 잘 맞아요.",
  ...
  gsd:
    "스펙, 로드맵, phase 같은 구조화된 개발 흐름이 중요해 보여요. GSD는 요구사항 정리부터 실행/검증까지 긴 호흡의 워크플로를 안정화해줘요.",
  fireauto:
    "SEO, 보안, 리서치, UI 개선처럼 서비스 운영 직전의 반복 작업이 보여요. fireauto는 이런 실전 커맨드를 한 번에 묶어둔 쪽에 강해요.",
  "sequential-thinking":
