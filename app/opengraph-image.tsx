  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex", fontSize: 48, fontWeight: 700, color: OG_COLORS.text, fontFamily: "Space Grotesk" }}>
            Plugin Advisor
          </div>
          <div style={{ display: "flex", fontSize: 24, color: OG_COLORS.muted, fontFamily: "Space Grotesk" }}>
            Claude Code Starter Setup Guide
          </div>
        </div>
