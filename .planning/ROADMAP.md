...
- [x] **Phase 11: Catalog Tab UI** - /plugins 페이지 MCP/Plugin 탭 분리 및 URL 상태 유지 (completed 2026-03-18)
- [x] **Phase 12: Optimizer UI + i18n** - 옵티마이저 힌트 업데이트, 타입 뱃지, i18n 완성 (completed 2026-03-18)
...
Plans:
- [x] 11-01-PLAN.md — PluginGrid activeType 상태 + URL sync, PluginSearch TabsList 렌더링, i18n allTabLabel, Suspense boundary
