...
## Current Milestone: v1.4 마케팅 준비

**Goal:** 마케팅 런칭 전 기술 준비 — Analytics, 소셜 공유, 피드백 수집 인프라 구축

**Target features:**
- 서버 측 Analytics (Vercel Analytics + 커스텀 이벤트 서버 전송)
- OG 이미지 최적화 (페이지별 동적 소셜 카드)
- 공유하기 버튼 (조합 분석 결과 SNS 공유)
- 피드백 폼 (사이트 내 피드백 위젯)
- 뉴스레터 구독 폼 (이메일 수집)
...
---
*Last updated: 2026-03-29 after v1.4 milestone start*
