...
현재 제품 방향은 `플러그인 추천기`보다 `Claude Code 입문자를 위한 검증된 스타터 스택 설치 어드바이저`에 맞춰 재정의되었습니다.
아래의 예전 확장 항목 중 커뮤니티/리뷰/OAuth/공유 갤러리 등은 우선순위에서 제외되었고, 현재는 설치 성공률과 세팅 점검 전환에 집중합니다.
